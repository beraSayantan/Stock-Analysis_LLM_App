from indicator_predictions import *
...
all_predictions.to_csv("./examples/csv/nifty_50_data.csv", index=False)

print('Dataset generated and saved to nifty_50_data.csv')


import json

# Load the CSV file
df = pd.read_csv("./examples/csv/nifty_50_data.csv")

# Define the JSONL file path
jsonl_file_path2= "./examples/data/nifty_50_data.jsonl"
...
jsonl_file_path1="./examples/data/_stock_tech_indicators.jsonl"

jsonl_combined_file_path ="./examples/data/stock_data_total.jsonl"
